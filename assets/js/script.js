...
// let students = ["Ramil", "Faxri", "Hesen", "Ferid"];
...
//     return sum;
// }
// console.log(numsByContidions([1, 2, 3, 4, 5, 6, 7], n => n % 2 == 0));
// console.log(numsByContidions([1, 2, 3, 4, 5, 6, 7], n => n % 2 != 0));

// console.log(numsByContidions([1, 2, 3, 4, 5, 6, 7],  n => n >= 5));
...
// console.log(sumThanThree([1, 2, 3, 4, 5, 6, 7],threeNum));
// console.log(sumOddNums([1, 2, 3, 4, 5, 6, 7], oddNum));

// console.log(sumEvenNums([1, 2, 3, 4, 5, 6, 7], evenNum));
